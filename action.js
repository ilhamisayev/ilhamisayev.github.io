...
function showUserCards() {
  ...
  filteredUsers.slice(0, visibleUsers).forEach(user => {
    ...
    userPageLink.href = createPageLink(user); 
...
fetch("https://raw.githubusercontent.com/ilhamisayev/ilhamisayev.github.io/main/JSON/action.json")
  .then(res => res.json())
  .then(data => {
